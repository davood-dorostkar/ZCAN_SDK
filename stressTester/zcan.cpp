...
//}
//
//void ZCAN::SendReceiveOnBus(int bus, const BYTE* data)
//{
//    DEVICE_HANDLE dhandle = ZCAN_OpenDevice(bus, 0, 0);
//    CHANNEL_HANDLE chHandle = this->InitCan(dhandle);
//    ZCAN_Transmit_Data* packet = this->SendMessage(chHandle, data);
//    ZCAN_Receive_Data* receive = this->ReceiveCanMessage(chHandle);
//}
//
...
//    DEVICE_HANDLE dhandle = ZCAN_OpenDevice(bus, 0, 0);
//    CHANNEL_HANDLE chHandle = this->InitCan(dhandle);
//    ZCAN_Transmit_Data* packet = this->SendMessage(chHandle, data, size);
//    ZCAN_Receive_Data* receive = this->ReceiveCanMessage(chHandle);
//}
//
